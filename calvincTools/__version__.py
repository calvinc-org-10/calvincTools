...
__version__ = "2026.04.06.1000"         # Use date-based versioning for easier tracking of updates. When package stabilizes, can switch to semantic versioning if desired. Format: YYYY.MM.DD.HHMM
sysver = {
    'DEV': f'DEV{_base_ver}', 
    'PROD': _base_ver,

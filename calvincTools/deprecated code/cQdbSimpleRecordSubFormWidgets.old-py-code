...
from calvincTools.utils.forms.cQdbSimpleRecordFormWidgets import OLDcSRF_Base
...
class cSimpRecSbFmRecord(cSimpRecFmElement_Base, OLDcSRF_Base):
...
# nope, don't inherit from cSimpleRecordForm - that double-defines layouts, buttons, etc. Copy what we need from it instead.
    ...
    # setDirty
# cSimpRecSbFmRecord
class cSimpleRecordSubForm2(cSimpRecFmElement_Base, OLDcSRF_Base):
